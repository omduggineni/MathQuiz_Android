...
public class Multiplication extends AppCompatActivity {
    ...
    public void setup(){
        ...
        num1 = getRandom(13);
        num2 = getRandom(13);
        text.setText(new String(String.valueOf(num1) + " x " + String.valueOf(num2)));
        sum = num1*num2;
        ...
        for(int i = 0; i < possiblevalues.length; i++){
            buttons[possiblevalues[i]].setText(String.valueOf(getRandom(144)));
        }
    ...
    public void Done(){
        if(answasright){
            ...
            intent.putExtra("Activity_Signature","M");
